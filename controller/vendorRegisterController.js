...
async function user_details_price(vendor) {
    var userExists = await vendorModel.findOne({_id: vendor.vendor_id}), details = null;
    if(userExists)
    {
        details = {
            _id: userExists._id,
            ...
            vendor_delivery_hours: vendor.delivery_hours,
            created_at: changeDateFormat(userExists.created_at),
            deleted_at: userExists.deleted_at != null ? changeDateFormat(userExists.deleted_at) : null
        }
    }
...
module.exports.user_details_price = user_details_price;