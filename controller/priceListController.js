                ...
                const newPrice = new priceListModel(
                    {
                        ...
                        discount: req.body.discount != undefined && req.body.discount != "undefined" && req.body.discount != null && req.body.discount != "null" && req.body.discount != "" && parseInt(req.body.discount) > 0 ? parseInt(req.body.discount) : 0, 
                        description: req.body.description != undefined && req.body.description != "undefined" && req.body.description != null && req.body.description != "null" && req.body.description != "" ? req.body.description : null,
...
async function get_price_info(data) {
    ...
    if(data)
    {
        ...
        result = {
            ...
            vendor: data.vendor != undefined && data.vendor != [] ? data.vendor : [],
